...
RUMUS_APALAN_AWAL_TAUN_MUKAROM_ABADI.set(_ROM_EHE, ROM_EHE)
RUMUS_APALAN_AWAL_TAUN_MUKAROM_ABADI.set(_ROM_JIMAWAL, ROM_JIMAWAL)
RUMUS_APALAN_AWAL_TAUN_MUKAROM_ABADI.set(_ROM_JE, ROM_JE)
RUMUS_APALAN_AWAL_TAUN_MUKAROM_ABADI.set(_ROM_DAL, ROM_DAL)
RUMUS_APALAN_AWAL_TAUN_MUKAROM_ABADI.set(_ROM_BE, ROM_BE)
RUMUS_APALAN_AWAL_TAUN_MUKAROM_ABADI.set(_ROM_WAWU, ROM_WAWU)
RUMUS_APALAN_AWAL_TAUN_MUKAROM_ABADI.set(_ROM_JIMAKIR, ROM_JIMAKIR)

export {
  RUMUS_APALAN_AWAL_TAUN_MUKAROM_ABADI,
  _ROM_ALIP,
  _ROM_EHE,
  _ROM_JIMAWAL,
  _ROM_JE,
