...
const ROBIULAWAL = { wulan: 'robiulawal', celukan: 'rowal', urutan: 3, cacah: [30] }
const ROBIULAKIR = { wulan: 'robiulakir', celukan: 'rokir', urutan: 4, cacah: [29] }
const JUMADILAWAL = { wulan: 'jumadilawal', celukan: 'juwal', urutan: 5, cacah: [30] }
const JUMADILAKIR = { wulan: 'jumadilakir', celukan: 'jukir', urutan: 6, cacah: [29] }
...
const DULKIJAH = { wulan: 'dulkijah', celukan: 'jah', urutan: 12, cacah: [29, 30] }
...
const SASI_ARR = [MUKAROM, SAPAR, ROBIULAWAL, ROBIULAKIR, JUMADILAWAL, JUMADILAKIR, ROJAB, SAKBAN, ROMADON, SAWAL, DULKODAH, DULKIJAH]
