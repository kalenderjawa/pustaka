...
RUMUS_APALAN_AWAL_TAUN_DULKIJAH_ABADI.set(_JAH_WAWU, JAH_WAWU)
RUMUS_APALAN_AWAL_TAUN_DULKIJAH_ABADI.set(_JAH_JIMAKIR, JAH_JIMAKIR)

export {
  RUMUS_APALAN_AWAL_TAUN_DULKIJAH_ABADI,
  _JAH_ALIP,
  _JAH_EHE,
  _JAH_JIMAWAL,
  _JAH_JE,
