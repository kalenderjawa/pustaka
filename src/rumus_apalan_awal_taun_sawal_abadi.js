...
RUMUS_APALAN_AWAL_TAUN_SAWAL_ABADI.set(_WAL_JIMAWAL, WAL_JIMAWAL)
RUMUS_APALAN_AWAL_TAUN_SAWAL_ABADI.set(_WAL_JE, WAL_JE)
RUMUS_APALAN_AWAL_TAUN_SAWAL_ABADI.set(_WAL_DAL, WAL_DAL)
RUMUS_APALAN_AWAL_TAUN_SAWAL_ABADI.set(_WAL_BE, WAL_BE)
