...
describe('Dulkijah day-count does not leak state between years (354 vs 355)', () => {
  test('1952 (Be, 354) → 29; 1911 (Dal, 355) → 30; registry stays [29,30]; re-call 1952 remains 29', async () => {
    ...
    const r1952 = await KalenderJawa.cariRumusAbadiAwalBulanTahunJawa(
      'dulkijah',
      1952
    );
    ...
    const r1911 = await KalenderJawa.cariRumusAbadiAwalBulanTahunJawa(
      'dulkijah',
      1911
    );
    ...
    const r1952Again = await KalenderJawa.cariRumusAbadiAwalBulanTahunJawa(
      'dulkijah',
      1952
    );
