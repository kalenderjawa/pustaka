...
RUMUS_APALAN_AWAL_TAUN_DULKODAH_ABADI.set(_DAH_JE, DAH_JE)
RUMUS_APALAN_AWAL_TAUN_DULKODAH_ABADI.set(_DAH_DAL, DAH_DAL)
RUMUS_APALAN_AWAL_TAUN_DULKODAH_ABADI.set(_DAH_BE, DAH_BE)
RUMUS_APALAN_AWAL_TAUN_DULKODAH_ABADI.set(_DAH_WAWU, DAH_WAWU)
RUMUS_APALAN_AWAL_TAUN_DULKODAH_ABADI.set(_DAH_JIMAKIR, DAH_JIMAKIR)

export {
  RUMUS_APALAN_AWAL_TAUN_DULKODAH_ABADI,
  _DAH_ALIP,
  _DAH_EHE,
  _DAH_JIMAWAL,
  _DAH_JE,
